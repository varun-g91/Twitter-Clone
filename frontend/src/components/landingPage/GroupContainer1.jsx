...
const CreateAccount = ({ openSignupModal }) => {
    return (
        <div className="mb-2 max-w-[23.75rem] w-[18.75rem] h-[2.5rem] basis-auto flex flex-col items-stretch min-h-0 min-w-0">
            <button
...
const SignInPrompt = ({ openLoginModal }) => {
    return (
        <div className="mt-[2.5rem] w-full flex flex-col items-stretch">
            ...
            <div className="button-container w-full max-w-[18.75rem]">
                <button className="flex items-center justify-center w-full px-4 py-2 border-2 border-[#536471] rounded-full" onClick={openLoginModal}>
...
const GroupContainer1 = ({ openSignupModal, openLoginModal }) => {
    return (
        <div className="box-border flex flex-col basis-auto right-[8%] flex-grow-0 flex-shrink-0 items-stretch justify-center relative min-h-0 min-w-0 p-0 m-0">
            ...
            <AppleButton />
            <OrDivider />
            <CreateAccount openSignupModal={openSignupModal} />
            <TermsOfService />
            <SignInPrompt openLoginModal={openLoginModal} />
        </div>
    );
};

export default GroupContainer1;
